...
exports.run = async(client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.channel.send('**Hoşgeldin Kayıt Olduktan Sonra Kuralları Okumayı Unutma** <@&759842245691179028> <@&759841860386029568> <@&759840900393861202> <@&758311979646451722> <@&758106281243836506>');
